...
#define GL_ZERO                           SCE_GXM_BLEND_FACTOR_ZERO
#define GL_ONE                            SCE_GXM_BLEND_FACTOR_ONE

#define GL_POINTS                         SCE_GXM_PRIMITIVE_POINTS
#define GL_LINES                          SCE_GXM_PRIMITIVE_LINES
#define GL_LINE_LOOP                      0x0002
#define GL_LINE_STRIP                     0x0003
#define GL_TRIANGLES                      SCE_GXM_PRIMITIVE_TRIANGLES
#define GL_TRIANGLE_STRIP                 SCE_GXM_PRIMITIVE_TRIANGLE_STRIP
#define GL_TRIANGLE_FAN                   SCE_GXM_PRIMITIVE_TRIANGLE_FAN
#define GL_QUADS                          0x0007
#define GL_ADD                            0x0104
#define GL_NEVER                          SCE_GXM_DEPTH_FUNC_NEVER
#define GL_LESS                           SCE_GXM_DEPTH_FUNC_LESS
#define GL_EQUAL                          SCE_GXM_DEPTH_FUNC_EQUAL
#define GL_LEQUAL                         SCE_GXM_DEPTH_FUNC_LESS_EQUAL
#define GL_GREATER                        SCE_GXM_DEPTH_FUNC_GREATER
#define GL_NOTEQUAL                       SCE_GXM_DEPTH_FUNC_NOT_EQUAL
#define GL_GEQUAL                         SCE_GXM_DEPTH_FUNC_GREATER_EQUAL
#define GL_ALWAYS                         SCE_GXM_DEPTH_FUNC_ALWAYS
#define GL_SRC_COLOR                      SCE_GXM_BLEND_FACTOR_SRC_COLOR
#define GL_ONE_MINUS_SRC_COLOR            SCE_GXM_BLEND_FACTOR_ONE_MINUS_SRC_COLOR
#define GL_SRC_ALPHA                      SCE_GXM_BLEND_FACTOR_SRC_ALPHA
#define GL_ONE_MINUS_SRC_ALPHA            SCE_GXM_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA
#define GL_DST_ALPHA                      SCE_GXM_BLEND_FACTOR_DST_ALPHA
#define GL_ONE_MINUS_DST_ALPHA            SCE_GXM_BLEND_FACTOR_ONE_MINUS_DST_ALPHA
#define GL_DST_COLOR                      SCE_GXM_BLEND_FACTOR_DST_COLOR
#define GL_ONE_MINUS_DST_COLOR            SCE_GXM_BLEND_FACTOR_ONE_MINUS_DST_COLOR
#define GL_SRC_ALPHA_SATURATE             SCE_GXM_BLEND_FACTOR_SRC_ALPHA_SATURATE
...
#define GL_FUNC_ADD                       SCE_GXM_BLEND_FUNC_ADD
#define GL_MIN                            SCE_GXM_BLEND_FUNC_MIN
#define GL_MAX                            SCE_GXM_BLEND_FUNC_MAX
#define GL_FUNC_SUBTRACT                  SCE_GXM_BLEND_FUNC_SUBTRACT
#define GL_FUNC_REVERSE_SUBTRACT          SCE_GXM_BLEND_FUNC_REVERSE_SUBTRACT
